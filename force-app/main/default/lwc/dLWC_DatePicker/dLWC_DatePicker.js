...
export default class LwcCalendar extends LightningElement {
    ...
    initializeJsCalendar() {
            ...
            currentYear = this.displayed_date.getFullYear();
            // eslint-disable-next-line no-alert
            this.template.querySelector('[data-id="select-01"]').value = currentYear;
        ...
        selectHandler(e) {
            ...
            // eslint-disable-next-line no-alert
            //alert(this.template.querySelector('[data-id="select-01"]').value);
            selectedYear = this.template.querySelector('[data-id="select-01"]').value;
